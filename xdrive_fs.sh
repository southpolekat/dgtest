...
gpssh -h sdw1 'echo "1,1.99" > /tmp/data/xdrive_1.csv' 
gpssh -h sdw1 'echo "2,2.99" > /tmp/data/xdrive_2.csv'
gpssh -h sdw2 'echo "3,3.99" > /tmp/data/xdrive_3.csv' 
gpssh -h sdw2 'echo "4,4.99" > /tmp/data/xdrive_4.csv'
