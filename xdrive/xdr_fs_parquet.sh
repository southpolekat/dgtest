...
[[xdrive.mount]]
name = "local_parquet"
argv = ["xdr_fs/xdr_fs", "parquet", "/mnt/s3fs/data"]
END
...
LOCATION ('xdrive://127.0.0.1:7171/local_parquet/xdrive_#SEGID#.parquet') 
FORMAT 'spq';
...
LOCATION ('xdrive://127.0.0.1:7171/local_parquet/xdrive_*.parquet') 
FORMAT 'spq';
